...
<head>
    ...
    <title>Daftar Catatan</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    
</head>

<body>
    <h2>Daftar Catatan</h2>
    <a href="pages/create.php"><button type="button" class="btn btn-primary">Tambah Catatan Baru</button></a>
    <a href="pages/aboutme.php"><button type="button" class="btn btn-primary">Tentang Saya</button></a>
    <br><br>
